...
--Exercise 1: Stored Procedure to Retrieve Employee Details by DepartmentID
...
EXEC sp_GetEmployeesByDepartment @DeptID = 3; -- Example: Get all employees from IT department
...
-- Recreate with IDENTITY on EmployeeID
CREATE TABLE Employees (
...
EXEC sp_InsertEmployee 
    ...
    SELECT * FROM Employees WHERE FirstName = 'Robert' AND LastName = 'Brown';
